...
namespace Noxico
{
    public partial class UpdateForm : Form
    {
        ...
        void wc_DownloadFileCompleted(object sender, AsyncCompletedEventArgs e)
        {
            ...
            {
                File.WriteAllText("update.bat",
                    "del Noxico.exe" + Environment.NewLine + "del Noxico.nox" + Environment.NewLine +
                    "ren Noxico._xe Noxico.exe" + Environment.NewLine + "ren Noxico._ix Noxico.nox" +
                    Environment.NewLine + "start Noxico.exe" + Environment.NewLine + "del update.bat");
