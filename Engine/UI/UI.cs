...
namespace Noxico
{
    public static class UIColors
    {
        ...
        {
            get { return Color.FromArgb(0x282424); }
        }

        public static Color WindowBorder
        {
            get { return Color.FromArgb(0x8A8A8A); }
        }

        public static Color RegularText
        {
            get { return Color.FromArgb(0xDADCDA); }
        }

        public static Color HighlightText
        {
            get { return Color.FromArgb(0xA6A6FA); }
        }

        public static Color DarkBackground
        {
            get { return Color.FromArgb(0x131111); }
        }

        public static Color LightBackground
        {
            get { return Color.FromArgb(0x3C3737); }
        }

        public static Color SelectedBackground
        {
            get { return Color.FromArgb(0x4C4747); }
        }

        public static Color SelectedBackUnfocused
        {
            get { return Color.FromArgb(0x342E2E); }
        }

        public static Color SelectedText
        {
            get { return Color.FromArgb(0xC3C448); }
        }

        public static Color Unfocused
        {
            get { return Color.FromArgb(0xB29967); }
        }
        ...
        public static Color StatusForeground
        {
            get { return Color.FromArgb(0x6463D8); }
        }
    }
    ...
    public abstract class UIElement
    {
        ...
        public void ReMove()
        {
            switch (relMode)
            {
                case 0: return;
                case 1:
                    Move(relLeft, relTop, relTo);
                    return;
                case 2:
                    MoveBelow(relLeft, relTop, relTo);
                    return;
                case 3:
                    MoveBeside(relLeft, relTop, relTo);
                    return;
            }
        }
    ...
    public class UIWindow : UIElement
    {
        ...
        public override void Draw()
        {
            ...
            if (!Text.IsBlank())
                NoxicoGame.HostForm.Write(caption, Title.A > 0 ? Title : Foreground, Background, Top,
                    Left + (Width / 2) - (caption.Length() / 2));
    ...
    public class UIButton : UIElement
    {
        ...
        public override void Draw()
        {
            for (var i = 0; i < Height; i++)
                NoxicoGame.HostForm.Write(new string(' ', Width), Foreground,
                    UIManager.Highlight == this ? UIColors.SelectedBackground : UIColors.SelectedBackUnfocused, Top + i,
                    Left);
            NoxicoGame.HostForm.Write(Text, UIManager.Highlight == this ? UIColors.SelectedText : UIColors.Unfocused,
                UIManager.Highlight == this ? UIColors.SelectedBackground : UIColors.SelectedBackUnfocused,
                Top + (Height / 2), Left + (Width / 2) - (Text.Length / 2));
        }
    }
    ...
    public class UIList : UIElement
    {
            ...
            for (var i = 0; i < Items.Count && i < Height; i++, t++)
                if (i + scroll >= Items.Count)
                    ...
                    NoxicoGame.HostForm.Write(' ' + Items[i + scroll].PadEffective(Width - 2) + ' ',
                        _index == i + scroll
                            ? UIManager.Highlight == this ? UIColors.SelectedText : UIColors.Unfocused
                            : Foreground,
                        _index == i + scroll
                            ? UIManager.Highlight == this ? UIColors.SelectedBackground : UIColors.SelectedBackUnfocused
                            : Background,
        ...
        public override void DoUp()
        {
            ...
            NoxicoGame.HostForm.Write(' ' + Items[pi].PadEffective(Width - 2) + ' ', Foreground, Background,
                Top + pi - scroll, Left);
            NoxicoGame.HostForm.Write(' ' + Items[_index].PadEffective(Width - 2) + ' ',
                UIManager.Highlight == this ? UIColors.SelectedText : UIColors.HighlightText,
                UIManager.Highlight == this ? UIColors.SelectedBackground : UIColors.SelectedBackUnfocused,
        ...
        private void DrawScrollArrows()
        {
            ...
            if (scroll + Height < Items.Count)
                NoxicoGame.HostForm.Write("\x1F", UIColors.RegularText, Color.Transparent, Top + Height - 1,
                    Left + Width - 1);
        }
    ...
    public class UITextBox : UIElement
    {
        ...
        public override void Draw()
        {
            NoxicoGame.HostForm.Write(Text.PadEffective(Width),
                UIManager.Highlight == this ? Foreground : UIColors.Unfocused, Background, Top, Left);
    ...
    public class UISingleList : UIList
    {
        ...
        public override void Draw()
        {
            NoxicoGame.HostForm.Write(Text.PadEffective(Width - 2) + "<cBlack,Gray>\x11\x10",
                UIManager.Highlight == this ? Foreground : UIColors.Unfocused, Background, Top, Left);
        }
    ...
    public class UIColorList : UISingleList
    {
        ...
        public UIColorList(string text, EventHandler enter, IEnumerable<string> items, int index = 0) : base(text,
            enter, items, index)
        {
        }
        ...
        public override void Draw()
        {
            ...
            NoxicoGame.HostForm.Write(Text.PadEffective(Width - 4) + "<cBlack,Gray>\x11\x10",
                UIManager.Highlight == this ? Foreground : UIColors.Unfocused, Background, Top, Left + 2);
        }
    }
    ...
    public class UIRadioList : UIElement
    {
        ...
        public override void Draw()
        {
            ...
            for (var i = 0; i < choices.Length; i++)
                NoxicoGame.HostForm.Write((val == i ? on : off) + ' ' + choices[i],
                    UIManager.Highlight == this
                        ? (ItemsEnabled[i] ? Foreground : Color.Gray)
                        : (ItemsEnabled[i] ? Color.Gray : Color.Silver), Background, Top + i, Left);
        }
    ...
    static class UIManager
    {
        ...
        public static void CheckKeys()
        {
            if (Subscreens.Mouse)
            {
                ...
                var item = Elements.FindLast(x =>
                    x.TabStop && x.Enabled && !x.Hidden && Subscreens.MouseX >= x.Left && Subscreens.MouseY >= x.Top &&
                    Subscreens.MouseX < x.Left + x.Width && Subscreens.MouseY < x.Top + (x.Height == 0 ? 1 : x.Height));
                if (item != null)
                {
                    if (item != highlight)
                    {
