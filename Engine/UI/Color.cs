...
namespace Noxico
{
    ...
    public struct Color
    {
        ...
        {
            get { return new Color(0x000000, "Transparent"); }
        }

        public static Color Black
        {
            get { return new Color(0xFF000000, "Black"); }
        }

        public static Color Silver
        {
            get { return new Color(0xFFC0C0C0, "Silver"); }
        }

        public static Color Gray
        {
            get { return new Color(0xFF808080, "Gray"); }
        }

        public static Color White
        {
            get { return new Color(0xFFFFFFFF, "White"); }
        }

        public static Color Maroon
        {
            get { return new Color(0xFF800000, "Maroon"); }
        }

        public static Color Red
        {
            get { return new Color(0xFFFF0000, "Red"); }
        }

        public static Color Purple
        {
            get { return new Color(0xFF800080, "Purple"); }
        }

        public static Color Fuchsia
        {
            get { return new Color(0xFFFF00FF, "Fuchsia"); }
        }

        public static Color Green
        {
            get { return new Color(0xFF008000, "Green"); }
        }

        public static Color Lime
        {
            get { return new Color(0xFF00FF00, "Lime"); }
        }

        public static Color Olive
        {
            get { return new Color(0xFF808000, "Olive"); }
        }

        public static Color Yellow
        {
            get { return new Color(0xFFFFFF00, "Yellow"); }
        }

        public static Color Navy
        {
            get { return new Color(0xFF000080, "Navy"); }
        }

        public static Color Blue
        {
            get { return new Color(0xFF0000FF, "Blue"); }
        }

        public static Color Teal
        {
            get { return new Color(0xFF008080, "Teal"); }
        }

        public static Color Aqua
        {
            get { return new Color(0xFF00FFFF, "Aqua"); }
        }

        public static Color Brown
        {
            get { return new Color(0xFF804000, "Brown"); }
        }

        public static Color Orange
        {
            get { return new Color(0xFFFFA500, "Orange"); }
        }

        public static Color DarkGray
        {
            get { return new Color(0xFF404040, "DarkGray"); }
        }
        ...
        public static Color FromCSS(string hexCode)
        {
            ...
            if (hexCode.Length == 3)
                hexCode = string.Join(string.Empty,
                    new char[] {hexCode[0], hexCode[0], hexCode[1], hexCode[1], hexCode[2], hexCode[2]});
