...
namespace Noxico
{
    ...
    public class ColorEditorControl : UserControl
    {
            ...
            if (colors == null)
            {
                ...
                foreach (var knownColor in knownColors)
                {
                    ...
                    var brush = new SolidBrush(
                        System.Drawing.Color.FromArgb((int) ((long) knownColor.Value | 0xFF000000)));
        ...
        void knownList_DrawItem(object sender, DrawItemEventArgs e)
        {
            ...
            var rect = new System.Drawing.Rectangle(e.Bounds.X + 1, e.Bounds.Y + 1, e.Bounds.Height - 2,
                e.Bounds.Height - 2);
            e.DrawBackground();
    ...
    public class ColorEditor : UITypeEditor
    {
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            if (context != null && context.Instance != null && provider != null)
            {
                ...
                {
                    var editor =
                        new ColorEditorControl((Color) Convert.ChangeType(value,
