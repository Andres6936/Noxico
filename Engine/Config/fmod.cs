...
namespace FMOD
{
    ...
    public enum ChannelMask : uint
    {
        ...
        SevenPtOne = FrontLeft | FrontRight | FrontCenter | LowFrequency | SurroundLeft | SurroundRight | BackLeft |
                     BackRight,
    }
    ...
    public delegate Result ChannelCallback(IntPtr channelRaw, ChannelCallbackType type, IntPtr commanddata1,
        IntPtr commanddata2);
    ...
    public delegate Result FileOpenCallback([MarshalAs(UnmanagedType.LPWStr)] string name, int unicode,
        ref uint fileSize, ref IntPtr handle, ref IntPtr userData);
    ...
    public class System : HandleBase
    {
        ...
        [DllImport(Version.Dll)]
        private static extern Result FMOD_System_Init(IntPtr system, int maxchannels, InitFlags flags,
        ...
        private static extern Result FMOD_System_CreateSound(IntPtr system, string name_or_data, SoundMode mode,
            ref CreateSoundExInfo exinfo, out IntPtr sound);

        [DllImport(Version.Dll, CharSet = CharSet.Unicode)]
        private static extern Result FMOD_System_CreateStream(IntPtr system, string name_or_data, SoundMode mode,
            ref CreateSoundExInfo exinfo, out IntPtr sound);

        [DllImport(Version.Dll, CharSet = CharSet.Unicode)]
        private static extern Result FMOD_System_CreateSound(IntPtr system, string name_or_data, SoundMode mode,
            int exinfo, out IntPtr sound);
        ...
        [DllImport(Version.Dll)]
        private static extern Result FMOD_System_CreateSound(IntPtr system, byte[] name_or_data, SoundMode mode,
            ref CreateSoundExInfo exinfo, out IntPtr sound);

        [DllImport(Version.Dll)]
        private static extern Result FMOD_System_CreateStream(IntPtr system, byte[] name_or_data, SoundMode mode,
            ref CreateSoundExInfo exinfo, out IntPtr sound);
        ...
        [DllImport(Version.Dll)]
        private static extern Result FMOD_System_PlaySound(IntPtr system, IntPtr sound, IntPtr channelGroup,
