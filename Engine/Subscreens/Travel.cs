    ...
    class Travel
    {
        ...
        public static void Handler()
        {
            ...
            if (Subscreens.FirstDraw)
            {
                ...
                var backdrop = new Bitmap(Program.Cols, Program.Rows * 2,
                ...
                UIManager.Elements.Add(new UILabel(i18n.GetString("travel_current") + "\n \x07<cCyan> " +
                                                   (host.Noxico.CurrentBoard.Name ?? "Somewhere"))
                {
                    Left = 44,
                    Top = (pageTop / 2) + 4,
                ...
                {
                    var thisBoard =
                        NoxicoGame.TravelTargets.FirstOrDefault(
                            tn => host.Noxico.CurrentBoard.Name.StartsWith(tn.Value));
