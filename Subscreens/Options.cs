    ...
    public static class Options
    {
        ...
        public static void Handler()
        {
            if (Subscreens.FirstDraw)
            {
                ...
                var fonts = Mix.GetFilesWithPattern("fonts\\*.png")
                ...
                keysButton = new UIButton(i18n.GetString("opt_keys"), (s, e) => { Controls.Open(); }) {Width = 16};
                keysButton.MoveBelow(0, 1, saveButton);
                openButton = new UIButton(i18n.GetString("opt_open"),
                    (s, e) => { System.Diagnostics.Process.Start(NoxicoGame.HostForm.IniPath); }) {Width = 16};
