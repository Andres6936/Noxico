...
namespace Noxico
{
    public static class Controls
    {
        ...
        private static void UpdateItems()
        {
            ...
            {
                controlList.Items[i] = i18n.GetString("key_" + Enum.GetName(typeof(KeyBinding), i)).PadEffective(16) +
                                       Toolkit.TranslateKey((KeyBinding) i, true, true);
            }
        }
        ...
        public static void Handler()
        {
            if (Subscreens.FirstDraw)
            {
                ...
                {
                    waitingForKey = true;
                    controlList.Items[controlList.Index] =
                        i18n.GetString("key_" + Enum.GetName(typeof(KeyBinding), controlList.Index)).PadEffective(16) +
                        "........";
