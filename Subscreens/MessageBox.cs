    ...
    public class MessageBox
    {
        ...
        public static void Handler()
        {
            ...
            if (NoxicoGame.IsKeyDown(KeyBinding.Back) || NoxicoGame.IsKeyDown(KeyBinding.Accept) ||
                Vista.Triggers == XInputButtons.A || Vista.Triggers == XInputButtons.B)
            {
                ...
                if (type == BoxType.Question)
                {
                    ...
                    else if ((NoxicoGame.IsKeyDown(KeyBinding.Back) || Vista.Triggers == XInputButtons.B) &&
                             onNo != null)
                    {
                        NoxicoGame.ClearKeys();
                        onNo();
        ...
        public static void List(string question, Dictionary<object, string> options, Action okay,
            bool allowEscape = false, bool doNotPush = false, string title = "", string icon = "")
        {
        ...
        public static void Input(string message, string defaultValue, Action okay, bool doNotPush = false,
